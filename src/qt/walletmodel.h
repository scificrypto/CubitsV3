...
/** Interface to Cubits wallet from Qt view code. */
...
public:
    ...
    SendCoinsReturn sendCoins(const QString &txcomment, const QList<SendCoinsRecipient> &recipients, int nSplitBlock, const CCoinControl *coinControl=NULL);
    ...
    bool isMine(const CCubitsAddress &address);
